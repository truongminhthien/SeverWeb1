...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Address::insert([
            [
                'id_user' => 1,
                'recipient_name' => 'Thiện Trương',
                'phone' => '0987654321',
                'address_line' => 'Số 1 Nguyễn Trãi, Thanh Xuân, Hà Nội',
                'status' => 'default',
            ],
            [
                'id_user' => 1,
                'recipient_name' => 'Tuấn Hiệp',
                'phone' => '0912345678',
                'address_line' => 'Số 2 Lê Lợi, Quận 1, TP. Hồ Chí Minh',
                'status' => 'non-default',
            ],
            [
                'id_user' => 2,
                'recipient_name' => 'Minh Tuấn',
                'phone' => '0909123456',
                'address_line' => 'Tòa nhà Ladeco, tầng 12A, số 266 Đội Cấn, Liễu Giai, Ba Đình, Hà Nội',
                'status' => 'default',
            ],
            [
                'id_user' => 2,
                'recipient_name' => 'Ngọc Trinh',
                'phone' => '0932123456',
                'address_line' => 'Số 10 Trần Hưng Đạo, Hoàn Kiếm, Hà Nội',
                'status' => 'non-default',
            ],
            [
                'id_user' => 3,
                ...
                'phone' => '0978123456',
                'address_line' => 'Số 5 Phạm Văn Đồng, Cầu Giấy, Hà Nội',
                'status' => 'default',
            ],
            [
                'id_user' => 3,
                'recipient_name' => 'Phương Linh',
                'phone' => '0967123456',
                'address_line' => 'Số 8 Nguyễn Huệ, Quận 1, TP. Hồ Chí Minh',
                'status' => 'non-default',
            ],
        ]);
        ...
        \App\Models\Voucher::insert([
            [
                ...
                'end_date' => '2025-12-31',
                'usage_limit' => 100,
                'description' => 'Giảm tối đa 500.000đ cho đơn hàng từ 5.000.000đ trở lên',
